 ...
 * 
 * import com.bca.entities.Brand; import com.bca.entities.Product; import
 * com.bca.entities.User; import com.bca.services.BrandService; import
 * com.bca.services.ProductService; import com.bca.services.UserService;
 * 
 ...
 * @Controller
 * 
 * @RequestMapping public class SeedController {
 * 
 ...
 * 
 * @GetMapping("/seed") public String seed() { Brand brand = new Brand();
 * brand.setBrand("Apple");
 * 
 ...
 * 
 * User user = new User(); user.setEmail("admin@domain.com");
 * user.setFullname("admin"); user.setPassword("admin");
 * user.setPhoto("admin.jpg"); user.setRole("admin"); userService.save(user);
 * return "redirect:/"; } }
 */